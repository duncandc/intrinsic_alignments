...
class CentralAlignment(object):
    ...
    def assign_orientation(self, **kwargs):
        ...
        intermediate_v = vectors_normal_to_planes(major_v, minor_v)

        # add orientations of central to galaxis to the galaxy table
        table['galaxy_axisA_x']= major_v[:,0]
        table['galaxy_axisA_y']= major_v[:,1]
        table['galaxy_axisA_z']= major_v[:,2]

        table['galaxy_axisB_x'] = intermediate_v[:,0]
        table['galaxy_axisB_y'] = intermediate_v[:,1]
        table['galaxy_axisB_z'] = intermediate_v[:,2]

...
from .monte_carlo_helpers import MonteCarloGalAnisotropicProf
...
class NFWPhaseSpace(NFWProfile, MonteCarloGalAnisotropicProf):
    ...
    def __init__(self, **kwargs):
        ...
        MonteCarloGalAnisotropicProf.__init__(self)
    ...
    def assign_phase_space(self, table, seed=None):
        ...
        """
        MonteCarloGalAnisotropicProf.mc_pos(self, table=table, seed=seed)
        if seed is not None:
            seed += 1
        MonteCarloGalAnisotropicProf.mc_vel(self, table=table, seed=seed)
    ...
    def setup_prof_lookup_tables(self, *concentration_bins):
        ...
        """
        MonteCarloGalAnisotropicProf.setup_prof_lookup_tables(self, *concentration_bins)
    ...
    def build_lookup_tables(self,
        ...
        """
        MonteCarloGalAnisotropicProf.build_lookup_tables(self, logrmin, logrmax, Npts_radius_table)
    ...
    def mc_unit_sphere(self, Npts, **kwargs):
        ...
        """
        return MonteCarloGalAnisotropicProf.mc_unit_sphere(self, Npts, **kwargs)
    ...
    def mc_solid_sphere(self, *concentration_array, **kwargs):
        ...
        """
        return MonteCarloGalAnisotropicProf.mc_solid_sphere(self, *concentration_array, **kwargs)
    ...
    def mc_halo_centric_pos(self, *concentration_array, **kwargs):
        ...
        """
        return MonteCarloGalAnisotropicProf.mc_halo_centric_pos(self, *concentration_array, **kwargs)
    ...
    def mc_pos(self, *concentration_array, **kwargs):
        ...
        """
        return MonteCarloGalAnisotropicProf.mc_pos(self, *concentration_array, **kwargs)
    ...
    def _vrad_disp_from_lookup(self, scaled_radius, *concentration_array, **kwargs):
        ...
        """
        return MonteCarloGalAnisotropicProf._vrad_disp_from_lookup(self,
    ...
    def mc_radial_velocity(self, scaled_radius, total_mass, *concentration_array, **kwargs):
        ...
        """
        return MonteCarloGalAnisotropicProf.mc_radial_velocity(self,
    ...
    def mc_vel(self, table, seed=None):
        ...
        """
        MonteCarloGalAnisotropicProf.mc_vel(self, table, seed=seed)
    ...
    def mc_generate_nfw_phase_space_points(self, Ngals=int(1e4), conc=5, mass=1e12,
        ...
        x, y, z = MonteCarloGalAnisotropicProf.mc_halo_centric_pos(self, c,
        ...
        if seed is not None:
            seed += 1
        vx = MonteCarloGalAnisotropicProf.mc_radial_velocity(self, scaled_radius, m, c, seed=seed)
        if seed is not None:
            seed += 1
        vy = MonteCarloGalAnisotropicProf.mc_radial_velocity(self, scaled_radius, m, c, seed=seed)
        if seed is not None:
            seed += 1
        vz = MonteCarloGalAnisotropicProf.mc_radial_velocity(self, scaled_radius, m, c, seed=seed)

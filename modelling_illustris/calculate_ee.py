...
def main():
    ...
    ee, cov = jackknife_ee_3d(gal_coords[selection_mask], gal_orientations_major[selection_mask],
                              gal_coords[selection_mask], gal_orientations_major[selection_mask],
                              rbins, period=Lbox,
    ...
    fname = sim_name + '_' + str(snapnum) + '-' + sample_name +'_ee.dat'

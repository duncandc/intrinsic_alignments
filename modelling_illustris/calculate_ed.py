...
def main():
    ...
    ed, cov = jackknife_ed_3d(gal_coords[selection_mask], gal_orientations_major[selection_mask],
                              gal_coords[selection_mask],
                              rbins, period=Lbox,
    ...
    fname = sim_name + '_' + str(snapnum) + '-' + sample_name +'_ed.dat'

...
def main():
    ...
    # all-all
    result1, result2, cov1, cov2 = jackknife_ee_3d_one_two_halo_decomp(halo_coords[mask],
    ...
    # central-central
    cc_result1, cc_result2, cc_cov1, cc_cov2 = jackknife_ee_3d_one_two_halo_decomp(halo_coords[mask],
                                        halo_orientations[mask],
                                        host_ids[mask],
                                        halo_coords[mask],
                                        halo_orientations[mask],
    ...
    # central-satellite
    cs_result1, cs_result2, cs_cov1, cs_cov2 = jackknife_ee_3d_one_two_halo_decomp(halo_coords[mask],
                                        halo_orientations[mask],
                                        host_ids[mask],
                                        halo_coords[mask],
                                        halo_orientations[mask],
    ...
    # satellite-central
    sc_result1, sc_result2, sc_cov1, sc_cov2 = jackknife_ee_3d_one_two_halo_decomp(halo_coords[mask],
                                        halo_orientations[mask],
                                        host_ids[mask],
                                        halo_coords[mask],
                                        halo_orientations[mask],
    ...
    # satellite-satellite
    ss_result1, ss_result2, ss_cov1, ss_cov2 = jackknife_ee_3d_one_two_halo_decomp(halo_coords[mask],
                                        halo_orientations[mask],
                                        host_ids[mask],
                                        halo_coords[mask],
                                        halo_orientations[mask],
    ...
    fname = simname + '_ee_one_two_halo_decomp.dat'
